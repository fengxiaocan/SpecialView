...
public class PraiseButton extends TextView implements View.OnClickListener, Runnable
{
    ...
    int DEFAULT_CHECK_BACKGROUND_ID = Color
            .WHITE;
    public final static @ColorInt
    int DEFAULT_CHECK_COLOR_ID = Color.BLACK;
    public final static @DrawableRes
    int DEFAULT_UNCHECK_BACKGROUND_ID =
            Color.WHITE;
    public final static @ColorInt
    int DEFAULT_UNCHECK_COLOR_ID = Color.GRAY;
    //是否能点击
    ...
    protected void init(AttributeSet attrs){
        ...
        TypedArray type = getContext()
                .obtainStyledAttributes(attrs,R.styleable.PraiseButton);
        isCheck = type.getBoolean(R.styleable.PraiseButton_praise,DEFAULT_CHECK);
        clickable = type.getBoolean(R.styleable.PraiseButton_praiseable,
                                    DEFAULT_CAN_CLICK);
        checkkBackgroundId = type
                .getResourceId(R.styleable.PraiseButton_praiseBackground,
                               DEFAULT_CHECK_BACKGROUND_ID);
        uncheckBackgroundId = type
                .getResourceId(R.styleable.PraiseButton_unpraiseBackground,
                               DEFAULT_UNCHECK_BACKGROUND_ID);
        checkColor = type.getColor(R.styleable.PraiseButton_praiseTextColor,
                                   DEFAULT_CHECK_COLOR_ID);
        uncheckColor = type.getColor(R.styleable.PraiseButton_unpraiseTextColor,
                                     DEFAULT_UNCHECK_COLOR_ID);
        mPraiseNumber = type
                .getInteger(R.styleable.PraiseButton_praiseNumber,0);
        setCheckDrawableTop(
                type.getDrawable(R.styleable.PraiseButton_praiseDrawableTop));
        setCheckDrawableLeft(
                type.getDrawable(R.styleable.PraiseButton_praiseDrawableLeft));
        setCheckDrawableBottom(
                type.getDrawable(R.styleable.PraiseButton_praiseDrawableBottom));
        setCheckDrawableRight(
                type.getDrawable(R.styleable.PraiseButton_praiseDrawableRight));
        setUncheckDrawableTop(
                type.getDrawable(R.styleable.PraiseButton_unpraiseDrawableTop));
        setUncheckDrawableLeft(
                type.getDrawable(R.styleable.PraiseButton_unpraiseDrawableLeft));
        setUncheckDrawableBottom(type.getDrawable(
                R.styleable.PraiseButton_unpraiseDrawableBottom));
        setUncheckDrawableRight(type.getDrawable(
                R.styleable.PraiseButton_unpraiseDrawableRight));
    ...
    public void setCheckkBackground(@DrawableRes int checkkBackgroundId){
        this.checkkBackgroundId = checkkBackgroundId;
        postInvalidate();
    }
    ...
    public void setCheck(boolean isCheck){
        ...
        if(this.isCheck){
            ...
            if(checkkBackgroundId != uncheckBackgroundId){
                setBackgroundResource(checkkBackgroundId);
            }
            super.setCompoundDrawables(mCheckDrawableLeft,mCheckDrawableTop,
                                       mCheckDrawableRight,
            ...
            super.setCompoundDrawables(mUncheckDrawableLeft,mUncheckDrawableTop,
                                       mUncheckDrawableRight,
                                       mUncheckDrawableBottom);
        }
    ...
    public void setCheckDrawableLeft(Drawable checkDrawableLeft){
        ...
        if(mCheckDrawableLeft != null){
            mCheckDrawableLeft
                    .setBounds(0,0,mCheckDrawableLeft.getMinimumWidth(),
    ...
    public void setCheckDrawableBottom(Drawable checkDrawableBottom)
    {
        ...
        if(mCheckDrawableBottom != null){
            mCheckDrawableBottom
                    .setBounds(0,0,mCheckDrawableBottom.getMinimumWidth(),
    ...
    public void setCheckDrawableRight(Drawable checkDrawableRight)
    {
        ...
        if(mCheckDrawableRight != null){
            mCheckDrawableRight
                    .setBounds(0,0,mCheckDrawableRight.getMinimumWidth(),
    ...
    public void setUncheckDrawableTop(Drawable uncheckDrawableTop)
    {
        ...
        if(mUncheckDrawableTop != null){
            mUncheckDrawableTop
                    .setBounds(0,0,mUncheckDrawableTop.getMinimumWidth(),
    ...
    public void setUncheckDrawableLeft(Drawable uncheckDrawableLeft)
    {
        ...
        if(mUncheckDrawableLeft != null){
            mUncheckDrawableLeft
                    .setBounds(0,0,mUncheckDrawableLeft.getMinimumWidth(),
    ...
    public void setUncheckDrawableBottom(Drawable uncheckDrawableBottom)
    {
        ...
        if(mUncheckDrawableBottom != null){
            mUncheckDrawableBottom
                    .setBounds(0,0,mUncheckDrawableBottom.getMinimumWidth(),
    ...
    public void setUncheckDrawableRight(Drawable uncheckDrawableRight)
    {
        ...
        if(mUncheckDrawableRight != null){
            mUncheckDrawableRight
                    .setBounds(0,0,mUncheckDrawableRight.getMinimumWidth(),
