...
public class PraiseButton extends TextView implements View.OnClickListener, Runnable {
	...
	public final static int DEFAULT_CHECK_BACKGROUND = Color.WHITE;
	public final static @ColorInt
	int DEFAULT_CHECK_COLOR = Color.BLACK;
	public final static int DEFAULT_UNCHECK_BACKGROUND = Color.WHITE;
	public final static @ColorInt
	int DEFAULT_UNCHECK_COLOR = Color.GRAY;
	...
	protected void init(AttributeSet attrs) {
		...
		checkkBackgroundId = type
				.getResourceId(R.styleable.PraiseButton_praiseBackground,DEFAULT_CHECK_BACKGROUND);
		uncheckBackgroundId = type.getResourceId(R.styleable.PraiseButton_unpraiseBackground,
		                                         DEFAULT_UNCHECK_BACKGROUND);
		checkColor = type.getColor(R.styleable.PraiseButton_praiseTextColor,DEFAULT_CHECK_COLOR);
		uncheckColor = type
				.getColor(R.styleable.PraiseButton_unpraiseTextColor,DEFAULT_UNCHECK_COLOR);
