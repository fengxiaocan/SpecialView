...
public class RingProgressBar extends View {
    ...
    public RingProgressBar(Context context,AttributeSet attrs,int defStyle) {
        ...
        textColor = mTypedArray.getColor(R.styleable.RingProgressBar_ringTextColor,Color.BLACK);
        textSize = mTypedArray.getDimension(R.styleable.RingProgressBar_ringTextSize,16);
    ...
    private void drawProgress(Canvas canvas) {
        ...
        //Stroke样式
        RectF strokeOval = new RectF(centre - radius,
                                     centre - radius,
                                     centre + radius,
                                     centre + radius
        );
