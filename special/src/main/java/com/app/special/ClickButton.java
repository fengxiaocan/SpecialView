...
public class ClickButton extends TextView implements View.OnClickListener {
	...
	int DEFAULT_CLICK_BACKGROUND_ID = R.drawable.shape_verify_click;
	public final static @ColorInt
	int DEFAULT_CLICK_COLOR_ID = Color.WHITE;
	public final static @DrawableRes
	int DEFAULT_UNCLICK_BACKGROUND_ID = R.drawable.shape_verify_unclick;
	public final static @ColorInt
	int DEFAULT_UNCLICK_COLOR_ID = Color.WHITE;
	...
	protected void init(AttributeSet attrs) {
		...
		clickBackgroundId = type
				.getResourceId(R.styleable.ClickButton_clickBackground,DEFAULT_CLICK_BACKGROUND_ID);
		unclickBackgroundId = type.getResourceId(R.styleable.ClickButton_unclickBackground,
		                                         DEFAULT_UNCLICK_BACKGROUND_ID);
		clickColor = type.getColor(R.styleable.ClickButton_clickTextColor,DEFAULT_CLICK_COLOR_ID);
		unclickColor = type
				.getColor(R.styleable.ClickButton_unclickTextColor,DEFAULT_UNCLICK_COLOR_ID);
		type.recycle();
