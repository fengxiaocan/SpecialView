...
public class CheckButton extends TextView implements View.OnClickListener{
    ...
    int DEFAULT_CHECK_BACKGROUND_ID = R
            .drawable.shape_verify_click;
    public final static @ColorInt
    int DEFAULT_CHECK_COLOR_ID = Color.WHITE;
    public final static @DrawableRes
    int DEFAULT_UNCHECK_BACKGROUND_ID = R
            .drawable.shape_verify_unclick;
    public final static @ColorInt
    int DEFAULT_UNCHECK_COLOR_ID = Color.WHITE;
    //是否能点击
    ...
    protected void init(AttributeSet attrs){
        ...
        TypedArray type = getContext()
                .obtainStyledAttributes(attrs,R.styleable.CheckButton);
        isCheck = type.getBoolean(R.styleable.CheckButton_check,DEFAULT_CHECK);
        mClickable = type.getBoolean(R.styleable.CheckButton_clickable,
                                     DEFAULT_CAN_CLICK);
        checkkBackgroundId = type
                .getResourceId(R.styleable.CheckButton_checkBackground,
                               DEFAULT_CHECK_BACKGROUND_ID);
        uncheckBackgroundId = type
                .getResourceId(R.styleable.CheckButton_uncheckBackground,
                               DEFAULT_UNCHECK_BACKGROUND_ID);
        checkColor = type.getColor(R.styleable.CheckButton_checkTextColor,
        ...
        setCheckDrawableTop(
                type.getDrawable(R.styleable.CheckButton_checkDrawableTop));
        setCheckDrawableLeft(
                type.getDrawable(R.styleable.CheckButton_checkDrawableLeft));
        setCheckDrawableBottom(
                type.getDrawable(R.styleable.CheckButton_checkDrawableBottom));
        setCheckDrawableRight(
                type.getDrawable(R.styleable.CheckButton_checkDrawableRight));
        setUncheckDrawableTop(
                type.getDrawable(R.styleable.CheckButton_uncheckDrawableTop));
        setUncheckDrawableLeft(
                type.getDrawable(R.styleable.CheckButton_uncheckDrawableLeft));
        setUncheckDrawableBottom(type.getDrawable(
                R.styleable.CheckButton_uncheckDrawableBottom));
        setUncheckDrawableRight(
                type.getDrawable(R.styleable.CheckButton_uncheckDrawableRight));
