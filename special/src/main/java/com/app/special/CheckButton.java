...
public class CheckButton extends TextView implements View.OnClickListener {
	...
	int DEFAULT_CHECK_BACKGROUND_ID = R.drawable.shape_verify_click;
	public final static @ColorInt
	int DEFAULT_CHECK_COLOR_ID = Color.WHITE;
	public final static @DrawableRes
	int DEFAULT_UNCHECK_BACKGROUND_ID = R.drawable.shape_verify_unclick;
	public final static @ColorInt
	int DEFAULT_UNCHECK_COLOR = Color.WHITE;
	//是否能点击
	...
	protected void init(AttributeSet attrs) {
		...
		checkkBackgroundId = type
				.getResourceId(R.styleable.CheckButton_checkBackground,DEFAULT_CHECK_BACKGROUND_ID);
		uncheckBackgroundId = type.getResourceId(R.styleable.CheckButton_uncheckBackground,
		                                         DEFAULT_UNCHECK_BACKGROUND_ID);
		checkColor = type.getColor(R.styleable.CheckButton_checkTextColor,DEFAULT_CHECK_COLOR_ID);
		uncheckColor = type
				.getColor(R.styleable.CheckButton_uncheckTextColor,DEFAULT_UNCHECK_COLOR);
